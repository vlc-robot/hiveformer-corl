...
for task in take_shoes_out_of_box slide_cabinet_open_and_place_cups change_channel; do # stack_cups stack_blocks tv_on; do  # TODO Likely OOM error, try cache_size_val=0
