...
# TODO Multi-task with larger model and larger support set
...
# TODO Multi-task with larger model and with/without global correspondence
#task_file=tasks/7_interesting_tasks.csv
#embedding_dim=120
#train_iters=500_000
#num_workers=12
...
# TODO Single task for all tasks
