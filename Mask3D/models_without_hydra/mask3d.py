...
from models_without_hydra.res16unet import Res16UNet34C
...
class Mask3D(nn.Module):
    def __init__(self,
        ...
        self.backbone = Res16UNet34C(
            in_channels=backbone_in_channels,
            out_channels=backbone_out_channels,
            dilations=backbone_dilations,
            bn_momentum=backbone_bn_momentum,
            conv1_kernel_size=backbone_conv1_kernel_size
        )
