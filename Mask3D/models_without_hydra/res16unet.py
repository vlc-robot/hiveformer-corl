...
from models_without_hydra.resnet import ResNetBase
...
class Res16UNetBase(ResNetBase):
    ...
    def __init__(self,
                 ...
                 bn_momentum, conv1_kernel_size, D=3, out_fpn=False, **kwargs):
        super().__init__(in_channels, out_channels, dilations,
