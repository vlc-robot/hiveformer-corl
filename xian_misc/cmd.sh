...
rsync -avzh --info=progress2  --exclude-from='/home/zhouxian/git/hiveformer/rsync-exclude-pth.txt' xianz1@matrix.ml.cmu.edu:/home/xianz1/git/hiveformer/train_logs/03_05*  /home/zhouxian/git/hiveformer/train_logs/
